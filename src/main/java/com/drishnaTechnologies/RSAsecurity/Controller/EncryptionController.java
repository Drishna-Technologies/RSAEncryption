...
public class EncryptionController {
	...
	public String encryptData(
		...
		String encryption = java.util.Base64.getEncoder().encodeToString(encryptedText);
		return encryption;
	}
