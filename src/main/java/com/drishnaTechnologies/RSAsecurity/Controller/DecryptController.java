...
public class DecryptController {
	...
	public String decryptData(@RequestBody encryptedText encryptedText)
		...
		byte[] decodedBase64ToCipherText = java.util.Base64.getDecoder().decode(encryptedText.getText());
		PrivateKey privateKey = null;
		byte[] privateKeyToBytes = java.util.Base64.getDecoder().decode(publicKey);
		PKCS8EncodedKeySpec keySpec = new PKCS8EncodedKeySpec(privateKeyToBytes);
		...
		// Decrypting the text
		byte[] decryptedCipherText = cipher.doFinal(decodedBase64ToCipherText);
